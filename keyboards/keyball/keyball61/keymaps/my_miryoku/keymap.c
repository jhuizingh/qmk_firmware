...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUMPAD] = LAYOUT_right_ball(
    _______  , _______  , KC_F10   , KC_F11   , KC_F12   , _______  ,                                  _______  , _______  , S(KC_8)  , S(KC_9) , S(KC_0) , KC_KP_MINUS  ,
    _______  , _______  , KC_F7    , KC_F8    , KC_F9    , _______  ,                                   _______  , KC_7     , KC_8     , KC_9    , KC_KP_PLUS  , KC_KP_PLUS  ,
    _______  , _______  , KC_F4    , KC_F5    , KC_F6    , _______  ,                                    _______  , KC_4    , KC_5    , KC_6     , KC_KP_EQUAL , KC_KP_EQUAL  ,
    _______  , _______  , KC_F1    , KC_F2    , KC_F3    , _______  , _______   ,            _______   , _______  , KC_1     , KC_2     , KC_3      , KC_SLASH  , _______  ,
