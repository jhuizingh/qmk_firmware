...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUMPAD] = LAYOUT_right_ball(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______ , KC_KP_PLUS  , KC_KP_PLUS  ,
    _______ , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______ , _______ , _______  , KC_KP_EQUAL , KC_KP_EQUAL  ,
