...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [4] = { ENCODER_CCW_CW(HK_ENC_SCR_D, HK_ENC_SCR_U), ENCODER_CCW_CW(HK_ENC_SCR_D, HK_ENC_SCR_U) },
    [5] = { ENCODER_CCW_CW(HK_ENC_SCR_D, HK_ENC_SCR_U), ENCODER_CCW_CW(HK_ENC_SCR_D, HK_ENC_SCR_U) },
    [6] = { ENCODER_CCW_CW(HK_ENC_SCR_D, HK_ENC_SCR_U), ENCODER_CCW_CW(HK_ENC_SCR_D, HK_ENC_SCR_U) },
    [7] = { ENCODER_CCW_CW(HK_ENC_SCR_D, HK_ENC_SCR_U), ENCODER_CCW_CW(HK_ENC_SCR_D, HK_ENC_SCR_U) },
};
#endif
// clang-format on
